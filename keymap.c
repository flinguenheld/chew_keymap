...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NUMERIC] = LAYOUT(
    //|---------+---------+---------+---------+---------|       |---------+--------+--------+--------+---------|
        _______ , XXXXXXX ,  US_OE  , US_PND  , XXXXXXX ,         KC_BSPC ,  KC_7  ,  KC_8  ,  KC_9  , XXXXXXX ,
    //|---------+---------+---------+---------+---------|       |---------+--------+--------+--------+---------|
         US_AE  , XXXXXXX , US_EURO , XXXXXXX , XXXXXXX ,         XXXXXXX ,  KC_4  ,  KC_5  ,  KC_6  ,  KC_0   ,
    //|---------+---------+---------+---------+---------|       |---------+--------+--------+--------+---------|
        XXXXXXX , XXXXXXX , XXXXXXX , XXXXXXX ,                              KC_1  ,  KC_2  ,  KC_3  , KC_DEL  ,
    //|---------+---------+---------+---------|                           |--------+--------+--------+---------|
    //                |------------+------------+---------|   |---------+---------+---------|
